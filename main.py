...
░╚════╝░░╚═════╝░  ░╚═════╝░╚═╝░░╚═╝╚══════╝╚═╝╚══════╝╚══════╝░╚════╝░  ░░░╚═╝░░░╚═════╝░
    ...
    print_border("INCO TESTNET", Fore.GREEN)
...
async def run_mintusdc(language: str):
    from scripts.mintusdc import run_mintusdc as mintusdc_run
    await mintusdc_run(language)

async def run_mintcusdc(language: str):
    from scripts.mintcusdc import run_mintcusdc as mintcusdc_run
    await mintcusdc_run(language)

async def run_shieldusdc(language: str):
    from scripts.shieldusdc import run_shieldusdc as shieldusdc_run
    await shieldusdc_run(language)

async def run_unshieldcusdc(language: str):
    from scripts.unshieldcusdc import run_unshieldusdc as unshieldcusdc_run
    await unshieldcusdc_run(language)
...
# Danh sách lệnh menu
SCRIPT_MAP = {
    "mintusdc": run_mintusdc,
    "mintcusdc": run_mintcusdc,
    "shieldusdc": run_shieldusdc,
    "unshieldcusdc": run_unshieldcusdc,
    "mintair": run_mintair,
    "sendtx": run_sendtx,
...
def get_available_scripts(language):
    scripts = {
        'vi': [
            {"name": "1. Mint USDC │ Inco Testnet", "value": "mintusdc"},
            {"name": "2. Mint cUSDC │ Inco Testnet", "value": "mintcusdc"},
            {"name": "3. Shield USDC ➯ cUSDC │ Inco Testnet", "value": "shieldusdc"},
            {"name": "4. Unshield cUSDC ➯ USDC │ Inco Testnet", "value": "unshieldcusdc"},
            {"name": "5. Deploy Smart Contract Mintair | Inco Testnet", "value": "mintair"},
            {"name": "6. Gửi TX ngẫu nhiên hoặc File (address.txt) | Inco Testnet", "value": "sendtx"},
            {"name": "7. Deploy Token smart-contract | Inco Testnet", "value": "deploytoken"},
            {"name": "8. Gửi Token ERC20 ngẫu nhiên hoặc File (addressERC20.txt) | Inco Testnet", "value": "sendtoken"},
            {"name": "9. Deploy NFT smart-contract | Inco Testnet", "value": "nftcollection"},
        ...
        'en': [
            ...
            {"name": "4. Unshield cUSDC ➯ USDC │ Inco Testnet", "value": "unshieldcusdc"},
            {"name": "5. Deploy Smart Contract Mintair | Inco Testnet", "value": "mintair"},
            {"name": "6. Send Random TX or File (address.txt) | Inco Testnet", "value": "sendtx"},
            {"name": "7. Deploy Token smart-contract | Inco Testnet", "value": "deploytoken"},
            {"name": "8. Send ERC20 Token Random or File (addressERC20.txt) | Inco Testnet", "value": "sendtoken"},
            {"name": "9. Deploy NFT smart-contract | Inco Testnet", "value": "nftcollection"},
